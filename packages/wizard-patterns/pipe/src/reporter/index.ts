...
// export abstract class PipeReporter<TInput = any, TOutput = TInput> extends Pipeline<TInput, TOutput> {
//   constructor(pipe: Pipe, opts: PipeOpts = {}) {
//     super([pipe], opts)
//     if (pipe.status !== PipeStatus.clean)
//       throw new Error('Cannot be created with an assembled or unassemblable pipe')
//   }
  
//   pipe(input: TInput): TOutput | Promise<TOutput> {
...
// export abstract class PipelineReporter<TInput = any, TOutput = TInput> extends PipeReporter<TInput, TOutput> {
